...
export default function SavingsPage() {
  ...
  useEffect(() => {
    const handleGlobalAdd = () => void savePlans();
    window.addEventListener("stark:add-savings", handleGlobalAdd);
    return () => window.removeEventListener("stark:add-savings", handleGlobalAdd);
  }, [goal, frequency, columns, rows]);
