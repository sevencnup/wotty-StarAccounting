      ...
      {activePanel ? (
        <div className="settings-sheet-overlay visible" onClick={() => setActivePanel(null)}>
          <section className="settings-sheet" onClick={(event) => event.stopPropagation()}>
            ...
            {activePanel === "ABOUT" ? <div className="settings-about"><span><SettingIcon type="ABOUT" /></span><strong>星记账</strong><p>版本 {packageInfo.version}</p><small>本地优先、可连接云端的个人财务管理工具</small><div>Next.js · Capacitor · Kotlin</div><nav className="settings-about-links" aria-label="相关网站"><a href="https://sevencn.com" target="_blank" rel="noreferrer"><span>官网</span><strong>sevencn.com</strong><ChevronIcon /></a><a href="https://starAccounting.wotty.app" target="_blank" rel="noreferrer"><span>项目地址</span><strong>starAccounting.wotty.app</strong><ChevronIcon /></a></nav></div> : null}
          </section>
        </div>
      ) : null}
    </div>
