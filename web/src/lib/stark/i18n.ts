...
const translations: Record<string, string> = {
  ...
  较小: "Small", 标准: "Standard", 较大: "Large", 星记账: "Stark Accounting", 版本: "Version", 前往GitHub提交反馈: "Send feedback on GitHub", 博客主站: "Blog home", 项目宣发地址: "Project page", 开源地址: "Open-source repository",
