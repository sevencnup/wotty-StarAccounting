...
```text
wotty-android-2.3.8.apk
```

如果以后有多个渠道包，可以这样：

```text
wotty-android-universal-2.3.8.apk
wotty-android-arm64-2.3.8.apk
wotty-android-debug-2.3.8.apk
```
...
```json
{
  ...
  "label": "Android 安装包",
  "fileName": "wotty-android-2.3.8.apk",
  "size": "28.4 MB",
  "description": "适用于大多数 Android 设备",
  "url": "/updates/downloads/wotty-android-2.3.8.apk"
}
```
...
```text
web/public/updates/downloads/wotty-android-2.3.8.apk
```
...
```json
{
  "url": "https://github.com/你的仓库/releases/download/v2.3.8/wotty-android-2.3.8.apk"
}
```
