...
建议新增一层布局容器，而不是直接把拖拽逻辑塞进 [DefaultDashboard.tsx](F:/1code/wotty-StarAccounting/web/src/features/dashboard/components/themes/DefaultDashboard.tsx)。
...
```ts
wotty.dashboard.layout.${accountId}.${dashboardVariant}
```
...
优先从 [DefaultDashboard.tsx](F:/1code/wotty-StarAccounting/web/src/features/dashboard/components/themes/DefaultDashboard.tsx) 开始。
...
[DashboardPageShell.tsx](F:/1code/wotty-StarAccounting/web/src/features/dashboard/components/DashboardPageShell.tsx) 继续负责：
