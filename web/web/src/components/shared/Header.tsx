...
export function Header() {
  ...
  function handleSearchSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (normalizeNavigationPath(targetHref) === normalizeNavigationPath(pathname)) {
      return;
    }

    warmNavigationRoute({ href: targetHref, themeId, router });
            ...
            {showDropdown ? (
              ...
              >
                ...
                <div className="mt-2 space-y-1">
                  <Link
                    href="/settings/"
                    onMouseEnter={() => warmNavigationRoute({ href: "/settings/", themeId, router })}
