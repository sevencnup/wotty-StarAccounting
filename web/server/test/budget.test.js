...
describe("Budget Logic", () => {
    ...
    it("should calculate total monthly expense for ALL category", () => {
        const budget = { amount: 1000, category: "ALL", period: "MONTHLY" };
